    ...
    <div className="md:px-8 px-4 py-2 shadow bg-base-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Desktop Theme Toggle + Login/Profile */}
          <div className="hidden md:flex items-center gap-3">
            ...
            {user ? (
              ...
              <Link
                to="/login"
                className="btn btn-sm bg-[#F9A825] text-white hover:bg-[#f57f17]"
              >
                Login
              </Link>
            )}
              ...
              {user ? (
                <>
                  ...
                  <li>
                    <button
                      onClick={handleLogout}
                      className="btn btn-sm w-full bg-[#F9A825] text-white hover:bg-[#f57f17]"
                    >
                      <FaSignOutAlt /> Logout
                    </button>
                  </li>
