...
const CharityProfile = () => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white dark:bg-gray-800 shadow-lg rounded p-6 mt-10">
      <img
        src={user?.photoURL}
      ...
      <p className="text-center text-gray-600 dark:text-gray-200">{user?.email}</p>
